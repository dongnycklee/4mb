"undefined" == typeof window.gambitScrollDecompositionRate &&
    (window.gambitScrollDecompositionRate = 0.94),
    "undefined" == typeof window.gambitScrollKeyAmount &&
        (window.gambitScrollKeyAmount = 16),
    "undefined" == typeof window.gambitScrollWheelAmount &&
        (window.gambitScrollWheelAmount = 12),
    "undefined" == typeof window.gambitUseRequestAnimationFrame &&
        (window.gambitUseRequestAnimationFrame = !0);
...
"undefined" == typeof Modernizr &&
    (window.Modernizr = (function (e, n, t) {
        ...
        var d = "2.8.3",
            ...
            _ = function (e, t, o, i) {
                ...
                return (
                    ...
                    s
                        ...
                        : (f.parentNode.removeChild(f), (c.style.overflow = d)),
                    !!l
                );
            },
            T = {}.hasOwnProperty,
            C;
        (C =
            r(T, "undefined") || r(T.call, "undefined")
                ? function (e, n) {
                      return (
    ...
    (function () {
        for (
            ...
            t < n.length && !window.requestAnimationFrame;
            ++t
        )
    ...
    (function () {
        function e(e) {
            40 === e.which
                ? ((l = !0),
                  (r = window.gambitScrollKeyAmount),
                  (i = -1),
                  (o = !0),
                  (a = window))
                : 38 === e.which &&
        ...
        function n(e) {
            if ((e.preventDefault && e.preventDefault(), !l)) {
                e.wheelDelta
                    ...
                    : d && e.detail
                    ? (i = -e.detail)
                    : e.detail && (i = -e.detail / 3),
                    (r = window.gambitScrollWheelAmount);
                var n = e.target;
                for (a = window; "HTML" != n.tagName; ) {
                    if (
                        n.scrollHeight > n.clientHeight &&
                        "undefined" != typeof n.style.overflow &&
                        "hidden" !== n.style.overflow &&
                        "visible" !== n.style.overflow &&
                        "" !== n.style.overflow
                    ) {
                        a = n;
                        break;
        ...
        function t() {
            o &&
                (a == window
                    ? a.scrollBy(a.scrollX, -i * r)
                    : (a.scrollTop = a.scrollTop - i * r),
                (r *= window.gambitScrollDecompositionRate),
                1 >= r && ((r = 0), (o = !1), (i = 0), (l = !1))),
                window.gambitUseRequestAnimationFrame
                    ? (window.requestAnimationFrame(t),
                      null != _gambitScrollInterval &&
        ...
        if ("undefined" == typeof _GAMBIT_SMOOTH_SCROLLER_DONE) {
            ...
            (Modernizr.touch && window.screen.width <= 1024) ||
                (window.screen.width <= 1281 && window.devicePixelRatio > 1) ||
                (window.addEventListener("mousewheel", n, { passive: false }),
